...
class Photo(models.Model):
    ...
    uploaded_by = models.CharField(max_length=255, help_text="Name of the guest who uploaded the photo")
...
class GuestbookMessage(models.Model):
    ...
    edit_token = models.UUIDField(default=uuid.uuid4, editable=False, help_text="Token for editing the message")
