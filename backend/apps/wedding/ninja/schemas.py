...
class PhotoUploadSchema(Schema):
    ...
    uploaded_by: str = Field(..., min_length=1, max_length=255, description="Name of the guest uploading the photo")
...
class GuestbookUpdateSchema(Schema):
    ...
    message: str = Field(..., min_length=1, max_length=2000, description="Updated guestbook message")
