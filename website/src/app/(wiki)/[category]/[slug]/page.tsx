    ...
    return (
        <article className="mx-auto max-w-4xl">
            ...
            <header className="mb-8">
                ...
                {/* Categories and Tags in separate sections */}
                {((article.categories && article.categories.length > 0) ||
                    article.tags.length > 0) && (
                    <div className="mb-6 space-y-3 rounded-lg border border-gray-700/50 bg-gray-800/30 p-4">
                        {/* Categories */}
                        {article.categories &&
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {article.categories.map((category) => (
                                            <Link
                                                key={category.id}
                                                href={`/${category.slug}`}
                                                className="rounded-lg border border-blue-500/30 bg-blue-500/10 px-2.5 py-1 text-xs font-medium text-blue-300 transition-colors hover:border-blue-400/50 hover:bg-blue-500/20"
                                            >
