...
export default function ImageCropperSimple({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
            <div className="relative w-full max-w-4xl overflow-hidden rounded-lg bg-[#1c324a] shadow-xl">
                {/* Header with close button */}
                <div className="flex items-center justify-between border-b border-gray-600 bg-[#1c324a] px-4 py-3">
                ...
                <div className="bg-[#1c324a] px-4 pt-5 pb-4 sm:p-6">
                    ...
                    <div className="mt-4 max-h-[40vh] space-y-4 overflow-y-auto sm:mt-6 sm:max-h-none sm:space-y-6 sm:overflow-y-visible">
                        ...
                        <div className="flex items-center gap-2 text-xs">
                            ...
                            <label htmlFor="rotation" className="text-gray-200">
                                Rotate
                            </label>
                            <input
                                id="rotation"
